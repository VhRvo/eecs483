...
fn main() {
    ...
    println!("it evaluates to {}", interpret(&a))
}
...
fn interpret(a: &Arith) -> i32 {
    match a {
        Arith::Leaf(n) => *n,
        Arith::Plus(l, r) => interpret(l) + interpret(r),
        Arith::Times(l, r) => interpret(l) * interpret(r),
    }
}

fn example() -> Arith {
    Arith::Plus(
        Box::new(Arith::Leaf(5)),
        Box::new(Arith::Times(
...
fn interpret1(t: &Arith) -> i32 {
    match t {
        Arith::Leaf(n) => *n,
        Arith::Plus(l, r) => interpret1(l) + interpret1(r),
        Arith::Times(l, r) => interpret1(l) * interpret1(r),
    }
}
